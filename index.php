...
<html lang="en">
<head>
<title>Knights Inn Resort</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Resort Inn Responsive , Smartphone Compatible web template"/>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Knights <span>INN</span><p class="logo_w3l_agile_caption">Get Further Away</p></a></h1>
				</div>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<img src="images/Beach.jpg" alt=" " class="img-responsive">
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">LUXURY ROOMS</h4>
							<span class="cbp-ig-category">KNIGHTS INN</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">WONDERFUL CAFE</h4>
							<span class="cbp-ig-category">KNIGHTS INN</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">WIFI ENABLED</h4>
							<span class="cbp-ig-category">KNIGHTS INN</span>
						</div>
					</li>
				</ul>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our KNIGHTS INN</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@KNIGHTS_INN.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> GLA University, Mathura, India</p>
...
<div class="copy">
	<p>© 2020 KNIGHTS INN . All Rights Reserved | Design by <a href="index.php">HARSH</a> </p>
</div>
