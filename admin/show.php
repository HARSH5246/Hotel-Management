...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>KNIGHTS INN HOTEL,</p>
				<p>New Adarsh Nagar,<br>Balkeshwar,<br>India.</p>
				<p>(+91) 7830944356</p>
			</address>
			<span><img alt="" src="assets/img/Knights%20Inn.jpg"></span>
		</header>
		<article>
			<h1></h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@knightsinn.com || Web :- www.knightsinn.com || Phone :- +91 7830944356 </p>
			</div>
		</aside>
	</body>
</html>
